...
export default class CliffLevel extends HelloWorldScene {
...
//400,530,800,50
    ...
    const scaleX = this.scale.width / cliffMap.widthInPixels;
    const scaleY = this.scale.height / cliffMap.heightInPixels;
